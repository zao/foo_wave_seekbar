...
seekbar_window::on_duration(double t)
{
    ...
    if (fe->frontend)
        fe->frontend->on_state_changed(
          static_cast<visual_frontend::state>(visual_frontend::state_position | visual_frontend::state_track));
}
...
#undef SET_REPLAYGAIN
    ...
    if (fe->frontend)
        fe->frontend->on_state_changed(static_cast<visual_frontend::state>(
          visual_frontend::state_replaygain | visual_frontend::state_position | visual_frontend::state_track));
}
...
seekbar_window::on_play()
{
    ...
    if (fe->frontend) {
        ...
        fe->frontend->on_state_changed(static_cast<visual_frontend::state>(visual_frontend::state_position));
    }
}
...
static const GUID order_repeat_playlist = { 0x681cc6ea,
                                            0x60ae,
                                            0x4bf9,
                                            { 0x91, 0x3b, 0xbb, 0x5f, 0x4e, 0x86, 0x4f, 0x2a } };
static const GUID order_repeat_track = { 0x4bf4b280,
                                         0x0bb4,
                                         0x4dd0,
...
static const GUID order_shuffle_tracks = { 0xc5cf4a57,
                                           0x8c01,
                                           0x480c,
                                           { 0xb3, 0x34, 0x36, 0x19, 0x64, 0x5a, 0xda, 0x8b } };
static const GUID order_shuffle_albums = { 0x499e0b08,
                                           0xc887,
                                           0x48c1,
                                           { 0x9c, 0xca, 0x27, 0x37, 0x7c, 0x8b, 0xfd, 0x30 } };
static const GUID order_shuffle_folders = { 0x83c37600,
                                            0xd725,
                                            0x4727,
...
seekbar_window::test_playback_order(t_size playback_order_index)
{
    ...
    if (current_order == order_default || current_order == order_repeat_playlist ||
        current_order == order_shuffle_albums || current_order == order_shuffle_folders) {
