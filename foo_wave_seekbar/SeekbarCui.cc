...
namespace wave
{
	...
	void seekbar_uie_base::color_callback::on_colour_changed(uint32_t changed_items_mask) const
	{
	...
	void seekbar_uie_base::color_callback::on_bool_changed(uint32_t changed_items_mask) const
	{}
