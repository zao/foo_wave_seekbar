...
void
transpose(C1& out, C2 const& in, size_t width, size_t valid_input_rows)
{
    size_t in_rows = in.get_size() / width, in_cols = width;
    size_t out_rows = in_cols, out_cols = in_rows;
