...
namespace wave {
ref_ptr<waveform>
downmix_waveform(ref_ptr<waveform> w, size_t target_channels)
{
    ...
    switch (target_channels) {
        case 1:
            ...
            break;
        case 2:
            ret->channel_map = audio_chunk::channel_config_stereo;
            break;
        default:
    ...
    for (auto I = &field_names[0]; *I; ++I) {
        ...
        for (size_t sample_index = 0; sample_index < 2048; ++sample_index) {
            ...
            switch (target_channels) {
                case 1:
                    dst[sample_index] = downmix_to_mono(frame, channel_count);
                    break;
                case 2: {
...
struct waveform_placeholder : waveform
{
    ...
    } // channel mask of bits 0 to 17 set.
