...
namespace wave
{
  namespace direct3d9
  {
    void config_dialog::scintilla_func::init(HWND wnd)
    {
    ...
    LRESULT config_dialog::on_effect_source_modified(NMHDR* hdr)
    {
    ...
    void config_dialog::on_effect_source_change(UINT code, int id, CEdit)
    {
