...
enum frontend
{
    frontend_direct3d11 = 0,
    frontend_direct2d1 = 2,
    frontend_gdi = 3,
};
enum display_mode
{
...
namespace strings {
__declspec(selectany) wchar_t const* frontend[] = { L"Direct3D 11.0", L"", L"Direct2D 1.0", L"GDI" };
...
{
    return RGB((BYTE)(c.a * c.b * 255), (BYTE)(c.a * c.g * 255), (BYTE)(c.a * c.r * 255));
}

inline COLORREF
color_to_xbgr(color c)
{
    return RGB((BYTE)(c.a * c.r * 255), (BYTE)(c.a * c.g * 255), (BYTE)(c.a * c.b * 255));
}
...
{
    std::string& s;
    explicit std_string_sink(std::string& s)
      : s(s)
    {
    }
