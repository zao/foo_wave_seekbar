...
void
seekbar_uie_base::get_name(pfc::string_base& out) const
{
...
void
seekbar_uie_base::color_callback::on_colour_changed(uint32_t mask) const
{
...
void
seekbar_uie_base::color_callback::on_bool_changed(uint32_t mask) const
{}
