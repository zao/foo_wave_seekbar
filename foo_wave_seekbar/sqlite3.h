...
#define SQLITE_SOURCE_ID "2009-11-04 13:30:02 eb7a544fe49d1626bacecfe53ddc03fe082e3243"
    ...
    ** for use in DLLs since DLL users usually do not have direct access to
    *string
...
#define double sqlite3_int64
    ...
    ** SQL statements without having to write a lot of C code.  The UTF-8
    *encoded
    ** SQL statements are passed in as the second parameter to sqlite3_exec().
    ** The statements are evaluated one by one until either an error or
    ** an interrupt is encountered, or until they are all done.  The 3rd
    *parameter
    ...
    ** The sqlite3_exec() routine does nothing to the database that cannot be
    *done
...
#define SQLITE_DBCONFIG_LOOKASIDE 1001 /* void* int int */
    ...
    ** [UPDATE] or [DELETE] statements since the [database connection] was
    *opened.
    ...
    ** single quotes) in place of the %Q option.  So, for example, one could
    *say:
    **
    ** <blockquote><pre>
    **  char *zSQL = sqlite3_mprintf("INSERT INTO table VALUES(%Q)", zText);
    ...
    ** the build-in random() and randomblob() SQL functions.  This interface
    *allows
...
#define SQLITE_LIMIT_TRIGGER_DEPTH 10
    ...
    ** as either UTF-8 or UTF-16.  The sqlite3_prepare() and
    *sqlite3_prepare_v2()
    ...
    **
    ** On success, [SQLITE_OK] is returned, otherwise an [error code] is
    *returned.
    **
    ...
    ** a way that makes the statement no longer valid, [sqlite3_step()] will
    *still
    ** return [SQLITE_SCHEMA].  But unlike the legacy behavior, [SQLITE_SCHEMA]
    *is
    ** now a fatal error.  Calling [sqlite3_prepare_v2()] again will not make
    *the
    ...
    ** automatically recompiled (as if there had been a schema change) on the
    *first
...
#define SQLITE3_TEXT 3
    ...
    ** [SQLITE_FLOAT], [SQLITE_TEXT], [SQLITE_BLOB], or [SQLITE_NULL].  The
    *value
    ...
    ** and BLOBs is freed automatically.  Do <b>not</b> pass the pointers
    *returned
    ...
    **
    ** {H11332} The [sqlite3_reset(S)] interface resets the [prepared statement]
    *S
    ...
    **          of any [sqlite3_bind_blob|bindings] on the [prepared statement]
    *S.
    */
...
*/
    ...
    ** [protected sqlite3_value] objects.  There is one [sqlite3_value] object
    *for
    ...
    **
    ** The implementation of aggregate SQL functions use this routine to
    *allocate
...
#define SQLITE_TRANSIENT ((sqlite3_destructor_type)-1)
    ...
    ** returned by sqlite3_db_handle is the same [database connection] that was
    *the first argument
    ...
    **          [SQLITE_OK] on success and [SQLITE_ERROR] if something goes
    *wrong.
    **
...
#define SQLITE_INDEX_CONSTRAINT_MATCH 64
    ...
    **
    ** {H17017} The other allowed parameters to sqlite3_mutex_alloc() each
    *return
    ...
    **
    ** {H17018} Note that if one of the dynamic mutex parameters
    *(SQLITE_MUTEX_FAST
    ...
    ** dynamic mutex that it allocates. {A17021} The dynamic mutexes must not be
    *in
    ...
    ** SQLITE_BUSY. {H17025}  The sqlite3_mutex_try() interface returns
    *[SQLITE_OK]
    ...
    ** routines that actually work. If the implementation does not provide
    *working
...
#define SQLITE_MUTEX_STATIC_LRU2 7 /* lru page list */
    ...
    **
    ** {H11301} The [sqlite3_file_control()] interface makes a direct call to
    *the
    ** xFileControl method for the [sqlite3_io_methods] object associated
    ** with a particular database identified by the second argument. {H11302}
    *The
    ** name of the database is the name assigned to the database by the
    ** <a href="lang_attach.html">ATTACH</a> SQL command that opened the
    ** database. {H11303} To control the main database file, use the name "main"
    ** or a NULL pointer. {H11304} The third and fourth parameters to this
    *routine
    ...
    ** also return SQLITE_ERROR.  {A11309} There is no way to distinguish
    *between
...
#define SQLITE_STMTSTATUS_SORT 2
    ...
    ** mimimum key value is 1. After it has been retrieved using xFetch, the
    *page
    ...
    ** zero, then the page is considered to be unpinned. The cache
    *implementation
    ...
    **
    ** The first two arguments passed to [sqlite3_backup_init()] are the
    *database
    ** handle associated with the destination database and the database name
    ** used to attach the destination database to the handle. The database name
    ** is "main" for the main database, "temp" for the temporary database, or
    ** the name specified as part of the [ATTACH] statement if the destination
    *is
    ...
    ** and an error code and error message written into the [database
    *connection]
    ...
    **
    ** Function [sqlite3_backup_step()] is used to copy up to nPage pages
    *between
    ...
    ** has not yet returned [SQLITE_DONE], then any active write-transaction on
    *the
    ** destination database is rolled back. The [sqlite3_backup] object is
    *invalid
    ...
    ** for this, if the application does use the destination [database
    *connection]
