...
static void
replace_filename(std::vector<wchar_t>& v, std::wstring const& new_name)
{
...
FOO_WAVE_SEEKBAR_VISUAL_FRONTEND_NAMED_ENTRYPOINT_HOOK(g_direct3d11_entrypoint,
                                                       wave::config::frontend_direct3d11,
                                                       wave::direct3d11::frontend_impl,
                                                       init_scintilla)
