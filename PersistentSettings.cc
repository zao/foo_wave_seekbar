...
namespace wave
{
	...
	struct compat_test_task : initquit
	{
		virtual void on_init()
		{
			char const* filenames[] =
			{
				"C:\\Code\\slask\\0.0.2.fth",
				"C:\\Code\\slask\\0.0.17.fth",
				"C:\\Code\\slask\\0.0.22.fth",
				"C:\\Code\\slask\\0.0.27.fth",
				"C:\\Code\\slask\\0.0.28.fth",
				"C:\\Code\\slask\\0.0.34.fth",
				"C:\\Code\\slask\\0.1.11.fth",
				"C:\\Code\\slask\\0.1.12.fth",
				"C:\\Code\\slask\\0.2.12.1.fth",
				"C:\\Code\\slask\\0.2.12.4.fth",
				"C:\\Code\\slask\\0.2.12.5.fth",
				"C:\\Code\\slask\\0.2.13.fth",
				"C:\\Code\\slask\\0.2.23.fth"
			};
			for (size_t i = 0; i < ARRAYSIZE(filenames); ++i)
			{
				std::string contents = slurp_file(filenames[i]);
				std::string xml = extract_xml_part(contents);

				persistent_settings settings;
				read_s11n_xml(xml, settings);

				pt::ptree out;
				settings.to_ptree(out);
				std::ofstream os(std::string(filenames[i]) + ".info");
				write_info(os, out);
			}

			{
				pt::ptree tree;
				std::ifstream is("C:\\Code\\slask\\0.2.23.fth.info");
				read_info(is, tree);

				persistent_settings settings;
				settings.from_ptree(tree);
			}
		}
...
static initquit_factory_t<wave::compat_test_task> g_asdf;
