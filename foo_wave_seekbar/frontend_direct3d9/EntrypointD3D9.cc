...
FOO_WAVE_SEEKBAR_VISUAL_FRONTEND_NAMED_ENTRYPOINT_HOOK(g_direct3d9_entrypoint, wave::config::frontend_direct3d9, wave::direct3d9::frontend_impl, init_scintilla)
